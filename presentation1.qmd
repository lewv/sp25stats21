...
- take a group photo
- upload it for class credit

## What to do in your group

- try to determine whether Python, git and some kind of code editor exist 
on your team's computers
...
- Objects have a type, also have attributes and methods.
...
Try assigning the literal value 7 to variables with different names. Try some illegal names to see what error messages Python tosses back to you.
